    ...
    <div class="modal-header" style="cursor: move;" id="settingsDragHandle">
      ...
      <div class="tab-panel" id="tab-analytics">
        ...
        <div class="setting-row" style="margin-top:10px;">
          ...
          <h3 style="color:var(--blue); margin-top:0; margin-bottom:15px; font-family:'Orbitron',sans-serif; letter-spacing:1px; font-size:1rem;">ADVANCED: CUSTOM API KEYS</h3>
          <p style="color:var(--dim); font-size:0.85rem; line-height:1.4; margin-bottom:15px;">Override the built-in Luna cloud with your own API Keys. You will have unlimited usage.</p>
